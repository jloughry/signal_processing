...
\begin{figure}[H] % `H' means force the figure not to float.
    \centering
    \subfloat[Printer $A$]{\includegraphics[width=0.45\columnwidth]{graphics/Figure" "02a.jpg}%
    \label{figure:Figure_02a}}
    \hfill
    \subfloat[Printer $B$]{\includegraphics[width=0.45\columnwidth]{graphics/Figure" "02b.jpg}%
