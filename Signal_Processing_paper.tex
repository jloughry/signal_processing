...
\begin{table}[!ht]
    \begin{tabular}{|l|c|c|c|c|}
        ...
        \hline
        Dual laser diode printer, Producer 2 & W1 & W & K1 & W1 \\
        \hline
    ...
    \caption[Figure 3]{Comparison of the quality of reconstructed
        ...
        \emph{Legend:}
        \begin{description}
            \item[K1] visible edges of graphic characters appear in the
                reconstructed image, but the information is legible;
            \item[K2] visible filled graphic characters appear in the
                reconstructed image, but the information is not legible;
            \item[W1] visible filled graphic characters appear in the
                reconstructed image, and the information is legible;
            \item[W2] graphic characters in the reconstructed image are not
