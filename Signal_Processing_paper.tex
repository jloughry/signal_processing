...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "15a" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "15a" "right.jpg}
        \label{figure:Figure_15a}
    }

    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "15b" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "15b" "right.jpg}
        \label{figure:Figure_15b}
    }

    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "15c" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "15c" "right.jpg}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "16a" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "16a" "right.jpg}
        \label{figure:Figure_16a}
    }

    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "16b" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "16b" "right.jpg}
        \label{figure:Figure_16b}
    }

    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "16c" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "16c" "right.jpg}
        \label{figure:Figure_16c}
    }

    \subfloat[]{
        \includegraphics[width=2.3in]{graphics/Figure" "16d" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=2.3in]{graphics/Figure" "16d" "right.jpg}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        ?? % \includegraphics[width=2.3in]{graphics/Figure" "20a.jpg}
        \label{figure:Figure_20a}
    }
    \hfil
    \subfloat[]{
        ?? % \includegraphics[width=2.3in]{graphics/Figure" "20b.jpg}
        \label{figure:Figure_20b}
    }

    \subfloat[]{
        ?? % \includegraphics[width=2.3in]{graphics/Figure" "20c.jpg}
        \label{figure:Figure_20c}
    }
    \hfil
    \subfloat[]{
        ?? % \includegraphics[width=2.3in]{graphics/Figure" "20d.jpg}
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        ?? % \includegraphics[width=2.3in]{graphics/Figure" "21a.jpg}
        \label{figure:Figure_21a}
    }
    \hfil
    \subfloat[]{
        ?? % \includegraphics[width=2.3in]{graphics/Figure" "21b.jpg}
...
\noindent In this case, different printing modes generate control signals
having different timing structures.
...
\begin{figure}[ht]
    \centering
    ?? % \includegraphics[width=3in]{graphics/Figure" "22.jpg}
...
\begin{table}[ht]
    \begin{tabular}{|l|c|c|c|c|}
        Type of Printer & \multicolumn{2}{c}{600\,dpi}
            & \multicolumn{2}{c}{1200\,dpi} \\
        \hline
        & Best & Eco & Best & Eco \\
        \hline
        Laser printer with dual laser \\
        diode system from Producer 1 & W1 & K1 & W1 & K1 \\
        \hline
        Laser printer with dual laser \\
        diode system from Producer 2 & W1 & W & K1 & W1 \\
        \hline
        Laser printer with dual laser \\
        diode system from Producer 3 & W1 & W1 & W1 & W1 \\
        \hline
        Laser printer with LED array: \\
        $A$ & K2 & K2 & K2 & K2 \\
        \hline
        Laser printer with LED array: \\
        $B$ & \textbf{W2} & \textbf{W2} & \textbf{W2} & \textbf{W2} \\
        \hline
    \end{tabular}
    \caption{Quality of reconstructed data depending on printing mode and
        the use of ``Best'' or ``Eco'' options  for laser printers with a
        dual diode laser system or an LED array from an electromagnetic
...
\begin{description}
    \item[K1] visible edges of graphic characters in the reconstructed image,
        information is legible;
    \item[K2] visible filled graphic characters in the reconstructed image,
        information is not legible;
    \item[W1] visible filled graphic characters in the reconstruct image,
        information is legible;
    \item[W2] graphic characters in the reconstructed image are not visible,
        information is not legible.
\end{description}
