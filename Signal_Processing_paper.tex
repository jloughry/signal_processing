...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{graphics/Figure" "01.jpg}
...
\begin{figure*}[!ht]
    \centering
    \subfloat[]{\includegraphics[width=\columnwidth]{graphics/Figure" "03a.jpg}%
    \label{figure:Figure_03a}}
    \hfill
    \subfloat[]{\includegraphics[width=\columnwidth]{graphics/Figure" "03b.jpg}%
...
\begin{figure}[!h]
    \centering
    \subfloat[Printer $A$]{\includegraphics[width=0.5\columnwidth]{graphics/Figure" "02a.jpg}%
    \label{figure:Figure_02a}}
    \hfill
    \subfloat[Printer $B$]{\includegraphics[width=0.5\columnwidth]{graphics/Figure" "02b.jpg}%
...
% table* makes a two-column table.
