...
the introduction of deliberately induced vulnerabilities, such as GUNMAN
\cite{Maneki2007a}.
...
\begin{figure*}[ht]
    \centering
    \subfloat[]{
        \includegraphics[width=\columnwidth]{graphics/Figure" "15a" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{graphics/Figure" "15a" "right.jpg}
        \label{figure:Figure_15a}
    }
    \hfill
    \subfloat[]{
        \includegraphics[width=\columnwidth]{graphics/Figure" "15b" "left.jpg}
        \hspace{\fill}
        \includegraphics[width=\columnwidth]{graphics/Figure" "15b" "right.jpg}
